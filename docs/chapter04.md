...
|---|---|---|---|---|---|---|---|
| QA-01 | Disponibilidad | La aplicación debe estar disponible las 24 horas del día, los 7 días de la semana. | Usuario final | Ingreso a la aplicación | Sistema | Disponibilidad 24/7 | US1–US38 |
| QA-02 | Seguridad |	Los historiales médicos solo pueden ser accedidos por cuidadores y familiares autorizados, tras autenticación exitosa en máximo 3 intentos.	| Usuario cuidador/familiar | Solicitud de acceso | Módulo de seguridad | Nº intentos ≤ 3 | US11, US12, US14 |
| QA-03 | Usabilidad | El familiar debe poder reservar una cita en menos de 5 minutos, sin necesitar capacitación previa. | Usuario familiar | Reserva de cita | Calendario de citas | Tiempo ≤ 5 min | US6, US7, US9 |
| QA-04 | Rendimiento | La aplicación debe enviar una notificación de cambio de salud en menos de 3 segundos desde que se registra el evento. | Sistema | Cambio de estado de salud | Componente de notificaciones | Tiempo en segundos ≤ 3 | US1, US4 |
...
![Containers Diagram](../assets/c4-contenedoresss.png)
...
- Components 
  ...
  - Appointment Service
    ...
    ![Appointment](../assets/AppointmentService.png)
